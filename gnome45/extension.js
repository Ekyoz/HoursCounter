/* extension.js
 *
 * Hours Counter - GNOME Shell Extension
...
class HistoryDialog extends ModalDialog.ModalDialog {
    _init() {
        ...
        scrollView.add_child(this._historyBox);
...
export default class HoursCounterExtension extends Extension {
    enable() {
        init();
        _settings = this.getSettings('org.gnome.shell.extensions.hours-counter');
        loadHistory();
