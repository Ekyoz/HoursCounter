...
function buildPrefsWidget() {
    const settings = ExtensionUtils.getSettings('org.gnome.shell.extensions.hours-counter');
    ...
    groupGoal.append(_createRow("Daily goal (hours)", spinGoal));
    ...
    groupDisplay.append(_createRow("Show remaining time in panel", switchRemaining));
    ...
    groupDisplay.append(_createRow("Language / Langue", langCombo));
    ...
    colors.forEach(c => {
        ...
        groupColors.append(_createRow(c.label, entry));
    });
...
function _createRow(label, widget) {
